...
QUESTION_RANGE = 'MS Questions!A:B'
...
def export_to_sheet(df):
    ...
    # gc.duplicate_sheet(SPREADSHEET_ID)
...
def process_data(sheet):
    ...
    try:
        ...
        1. You ran the middle_school.py script on high school data, when you should have run high_school.py. If this is the case, 
    ...
    df["Prior participation in our programs"] = df["Prior participation in our programs (Selected Choice)"] + " " + df["Prior participation in our programs (Write In)"] 
